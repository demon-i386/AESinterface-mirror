...
#define BLOCKLEN 16            // 16 byes (128 bits) block lenght
#define ROUNDS   10            // AES128 Rounds
typedef uint8_t state_t[4][4]; // Blocks that holds the cyphertext, 4 rows and 128/32 columns
